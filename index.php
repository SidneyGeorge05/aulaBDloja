            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card border-0 shadow rounded-3 my-5">
                    <div class="card-body p-6 p-sm-5">
                        ...
                        <br>
                        <form method="post" action="categoriaSuc.php">
                            <div class="form-floating">
                                <input type="text" name="txtcat" class="form-control" id="floatingInput" placeholder="Insira uma categoria de seu desejo">
                                <label for="floatingInput">Insira uma categoria de seu desejo</label>
                            </div>
                            <br>
                            <div class="d-grid">
